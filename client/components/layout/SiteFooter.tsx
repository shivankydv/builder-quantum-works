      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid gap-6 md:grid-cols-3">
        <div>
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} AquaSynth AI. Advancing oceanography,
            fisheries, and molecular biodiversity through AI.
          </p>
        </div>
        <div className="text-sm text-muted-foreground space-y-1">
          <p>
            Built for accessibility and real-time insights. Data privacy and
            ethical AI by design.
          </p>
          <p>Contact: hello@aquasynth.ai</p>
        </div>
